...
public final class StringUtil {
     ...
     */
    public static String encodePassword(String password, String algorithm) throws Exception {
...
*/
    ...
    public static String reverse(String str) {
        ...
        StringBuffer reverseStringBuffer = new StringBuffer(str);
        reverseStringBuffer = reverseStringBuffer.reverse();
        String reverseString = reverseStringBuffer.toString();
